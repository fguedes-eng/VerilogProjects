...
# Generated on: Wed Mar 18 19:52:02 -03 2026 (Wed Mar 18 22:52:02 UTC 2026)
...
set logfile fv/RISC_V/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/RISC_V -revised fv_map
...
add_search_path /pdk/gpdk045/gsclib045_svt_v4.7/gsclib045/timing -library -both
read_library -liberty -both \
    /pdk/gpdk045/gsclib045_svt_v4.7/gsclib045/timing/fast_vdd1v2_basicCells.lib
...
add_search_path /prj/ci/workarea/aluno22/verilog/result -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /prj/ci/workarea/aluno22/verilog/result/AA_mnemonics_pkg.sv /prj/ci/workarea/aluno22/verilog/result/ALU.sv /prj/ci/workarea/aluno22/verilog/result/Control_unit.sv /prj/ci/workarea/aluno22/verilog/result/Data_memory.sv /prj/ci/workarea/aluno22/verilog/result/Instruction_decoder.sv /prj/ci/workarea/aluno22/verilog/result/Instruction_memory.sv /prj/ci/workarea/aluno22/verilog/result/Multiplexers.sv /prj/ci/workarea/aluno22/verilog/result/Program_Counter.sv /prj/ci/workarea/aluno22/verilog/result/Registers.sv /prj/ci/workarea/aluno22/verilog/result/RISCV.sv
elaborate_design -golden -root {RISC_V} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/RISC_V/fv_map.v.gz
elaborate_design -revised -root {RISC_V}
...
#add_name_alias fv/RISC_V/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.RISC_V.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.RISC_V.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.RISC_V.rtl.fv_map.rpt
