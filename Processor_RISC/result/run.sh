...
xrun -Q -unbuffered '-timescale' '1ns/1ns' '-sysv' '-access' '+rw' '-coverage' 'all' '-sv' 'AA_mnemonics_pkg.sv' 'ALU.sv' 'Control_unit.sv' 'Instruction_decoder.sv' 'Instruction_memory.sv' 'Data_memory.sv' 'Multiplexers.sv' 'Program_Counter.sv' 'Registers.sv' -uvmnocdnsextra -uvmhome $UVM_HOME $UVM_HOME/src/uvm_macros.svh -input run.do design.sv testbench.sv  ; echo 'Creating result.zip...' && zip -r /tmp/tmp_zip_file_123play.zip . && mv /tmp/tmp_zip_file_123play.zip result.zip